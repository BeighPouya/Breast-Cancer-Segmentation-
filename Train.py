...
model = build_unet2D(input_shape, 32, False)
...
axes[2, 0].imshow(y_test_combined[a], cmap='gray')
axes[2, 0].set_title('Model Segmentation 1')

# Display the second image in the second subplot
axes[2, 1].imshow(y_test_combined[a+100], cmap='gray')
axes[2, 1].set_title('Model Segmentation 2')

axes[2, 2].imshow(y_test_combined[a+200], cmap='gray')
axes[2, 2].set_title('Model Segmentation 3')

axes[2, 3].imshow(y_test_combined[a+300], cmap='gray')
